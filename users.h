...
void agregaNuevoUserArchi(stUsuario nuevoUser);        ///guarda en archivo un nuevo user
...
int verificaId(stCelda enJuego[],int validos, int nuevaId);                      ///Verifica que el id nuevo no este ocupado
